...
const getOrderItem = (params,callback) => {
    let query = " select pi.img,oi.id as order_id,oit.imag,oit.remark,oi.recv_name,oi.recv_phone,oi.recv_address,pi.id as product_id,pi.product_name,ui.wechat_name,uc.license_plate,oit.id,oi.order_name,oit.prod_count,oit.unit_price,oit.freight,oit.total_price,ui.user_name,ui.phone,oit.created_on,oi.payment_status,oi.log_status from order_item oit " +
