...
const getOrder = (params,callback) => {
    let query = " select oi.recv_name,oi.recv_phone,oi.recv_address,oi.order_name,ui.wechat_name,oi.id,oi.order_name,oi.prod_count,oi.total_freight,oi.total_price,ui.user_name,ui.phone,oi.created_on,oi.payment_status,oi.log_status from order_info oi " +
